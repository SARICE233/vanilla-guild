...
@REM Resolve maven-wrapper.jar
if exist "%MAVEN_HOME%" goto downloadMaven
echo Downloading Maven wrapper...
powershell -Command "& {[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; Invoke-WebRequest -Uri 'https://repo.maven.apache.org/maven2/org/apache/maven/wrapper/maven-wrapper/3.3.2/maven-wrapper-3.3.2.jar' -OutFile '%MAVEN_HOME%'}"
...
set "MAVEN_DIR=%USERPROFILE%\.m2\wrapper\dists\apache-maven-3.9.9"
...
"%JAVACMD%" -cp "%MAVEN_HOME%" org.apache.maven.wrapper.MavenWrapperMain %MAVEN_CMD_LINE_ARGS%
goto end
